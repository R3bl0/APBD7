...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, depts) => new
            {
                emp.Ename,
                emp.Job,
                depts.Dname
        ...
        {
            int result = arr.GroupBy(num => num).Where(group => group.Count()%2==1).Select(e=>e.Key).First();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts.GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emps) => new
            {
                ...
                .Where(d=>d.EmpCount == 5 || d.EmpCount == 0)
                .Select(d=>d.Dept)
                .OrderBy(d=>d.Dname);
            return result;
        }
